...
export default function ContainerMinesControler(props){
    ...
    <Container className={`${props.gameStart? "displayMobile": ""}`}> 
        ...
        <SeletorMines id="seletorMines" name="seletorMines"  onChange={(e) => props.onChange(e.target.value)}>
        ...
        <BotaoStartGame onClick={props.sortearMines}>Começar o jogo</BotaoStartGame>
